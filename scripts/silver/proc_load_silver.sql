...
Purpose:
  ...
  It performs the following actions:
    ...
    - Inserts cleaned and transformed data into the silver tables.

Parameters:
  None (This stored procedure does not accept or return any parameters.)
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '>> Truncate data from table: silver.crm_cust_info';
        ...
        -- ==============================================================
        SET @start_time = GETDATE();
        PRINT '>> Truncate data from table: silver.crm_prd_info';
        ...
        SELECT 
            ...
            CAST(LEAD(prd_start_date) OVER (PARTITION BY prd_key ORDER BY prd_start_date ASC) - 1 AS DATE) AS prd_end_date
        ...
        -- ==============================================================
        SET @start_time = GETDATE();
        PRINT '>> Truncate data from table: silver.crm_sales_details';
        ...
        -- ==============================================================
        SET @start_time = GETDATE();
        PRINT '>> Truncate data from table: silver.erp_cust_az12';
        ...
        -- ==============================================================
        SET @start_time = GETDATE();
        PRINT '>> Truncate data from table: silver.erp_loc_a101';
        ...
        -- ==============================================================
        SET @start_time = GETDATE();
        PRINT '>> Truncate data from table: silver.erp_px_cat_g1v2';
